import type { FiberTarget } from "@fitness-autopilot/contracts";
import { FIBER_POLICY_VERSION } from "@fitness-autopilot/contracts";
import { err, ok, type Result } from "@fitness-autopilot/validation";
import { roundGrams, roundHalfUp } from "../common/rounding";
