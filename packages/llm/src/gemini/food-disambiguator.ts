import type { FoodResolutionCandidate, ResolvedRecipeIngredient } from "@fitness-autopilot/contracts";
import { FOOD_DISAMBIGUATION_PROMPT_VERSION } from "@fitness-autopilot/contracts";
import type { SemanticFoodDisambiguator } from "@fitness-autopilot/domain";
import type { LlmServerConfig } from "../config";
import type { GeminiContentClient } from "./client";
import { createGoogleGenAiContentClient } from "./google-client";
import { withGeminiRetries } from "./retry";
