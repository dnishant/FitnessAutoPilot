  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Pressable
        ...
        onPress={() => router.push("/weekly-strategy-preview")}
      >
        <Text style={styles.devButtonText}>Dev: Weekly Strategy Preview</Text>
      </Pressable>
      ...
      <Pressable
        style={styles.devButton}
        onPress={() => router.push("/candidate-ranking-preview")}
      >
        <Text style={styles.devButtonText}>Dev: Candidate Ranking</Text>
      </Pressable>
      <Pressable
        style={styles.devButton}
        onPress={() => router.push("/recipe-resolution-preview")}
      >
      ...
      <Pressable
        style={styles.devButton}
        onPress={() => router.push("/meal-composition-preview")}
      >
        <Text style={styles.devButtonText}>Dev: Meal Composition</Text>
      </Pressable>
