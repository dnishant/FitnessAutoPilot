...
} from "../food-resolution/nutrition-arithmetic.ts";
import { defaultQuantityNormalizer } from "../food-resolution/quantity-normalizer.ts";
import { hasRequiredMacros } from "./nutrition.ts";
