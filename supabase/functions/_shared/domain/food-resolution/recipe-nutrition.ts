...
import type { FoodResolver } from "./food-resolver.ts";
import { calculateNutritionForGrams, scaleNutrition, sumIngredientNutrition } from "./nutrition-arithmetic.ts";
import { defaultQuantityNormalizer, type QuantityNormalizer } from "./quantity-normalizer.ts";
...
export function createSharedFoodResolutionContext(): {
  ...
  diagnostics: MutableDiagnostics;
  inflight: Map<string, Promise<import("../../contracts/index.ts").FoodResolutionResult>>;
} {
  return {
