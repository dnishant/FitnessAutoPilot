...
import { matchBuiltinFood } from "./builtin-foods.ts";
import { scoreFoodCandidates, selectFoodCandidate } from "./candidate-scoring.ts";
import type { FoodDataProvider } from "./food-data-provider.ts";
import { FoodDataProviderException } from "./food-data-provider.ts";
import { buildIngredientResolutionKey } from "./ingredient-key.ts";
import { hasRequiredCanonicalNutrition } from "./nutrient-mapper.ts";
