...
| Protein / carbs / fat (g) | Round half-up to 1 decimal place |
...
2. Macro calorie reconciliation for targets: `protein*4 + carbs*4 + fat*9` must be within **±2%** of target calories (or ±30 kcal, whichever is larger) for acceptance tests of `nutrition-target-v1`.
